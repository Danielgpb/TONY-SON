...
export const services: Service[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    titleTag: 'Coloration Bruxelles – Couleur sur mesure | Tony&Son',
    metaDescription: 'Colorations capillaires à Bruxelles chez Tony&Son, salon à Schuman depuis 1970. Coloration, retouche racines, végétale. Dès 40 €. ☎ 02 230 55 37',
...
Rue Bonneels 27, à deux minutes du métro Schuman (lignes 1 et 5). Retrouvez l'ensemble de nos services sur notre page <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Réservez votre créneau en ligne via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a> — les créneaux du mercredi midi partent vite, pause déjeuner des institutions oblige.`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    titleTag: 'Balayage Bruxelles – Caramel, miel, blond, babylights | Tony&Son',
    metaDescription: 'Balayage à Bruxelles chez Tony&Son (Schuman) : caramel, miel, blond, cendré, babylights. Peint à main levée, retouche tous les 3-4 mois. Dès 35 €, brushing inclus. ☎ 02 230 55 37',
...
Rue Bonneels 27, entre le Parc du Cinquantenaire et le métro Schuman (lignes 1/5). Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Réservez en ligne via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a> ou au 02 230 55 37.`,
    faq: [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaDescription: 'Brushing professionnel à Bruxelles chez Tony&Son, Schuman. Lisse, volume ou wavy. Shampooing inclus. Dès 30 €. ☎ 02 230 55 37',
...
Lisse, volume ou wavy — shampooing et soin protecteur thermique inclus, à partir de 30 €. Tenue : 2-4 jours selon la texture et la météo bruxelloise. Nos coiffeurs vous filent deux-trois astuces concrètes — taie en satin, spray fixant, pas d'attache le premier soir — pour que ça tienne jusqu'au vendredi. Combinable avec une <a href="/fr/services/colorations-capillaires-bruxelles/">coloration</a> ou un <a href="/fr/services/lissage-cheveux-bruxelles/">lissage</a> dans la même séance. Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Réservez en ligne sur <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a> ou au 02 230 55 37. Rue Bonneels 27, à deux pas du métro Schuman.`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    titleTag: 'Lissage Brésilien Bruxelles – Tanin & Botox capillaire | Tony&Son',
    metaDescription: 'Lissage brésilien, tanin et botox capillaire à Bruxelles chez Tony&Son (Saint-Josse). Produits sans formol, conformes normes EU. Dès 150 €, fiche produit visible. ☎ 02 230 55 37',
...
Après le traitement : shampooing sans sulfate obligatoire, pas d'attache ni de lavage pendant 48-72h. On vous remet les instructions par écrit. Rue Bonneels 27, à côté du métro Schuman (lignes 1/5). Accessible depuis Etterbeek, Ixelles, Schaerbeek et le quartier européen. Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Appelez au 02 230 55 37 ou réservez via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a>.`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    titleTag: 'Repousse capillaire Bruxelles – Anti-chute | Tony&Son',
    metaDescription: 'Soins repousse capillaire à Bruxelles chez Tony&Son. Traitements anti-chute, stimulation de la pousse. Schuman depuis 1970. ☎ 02 230 55 37',
    h1: 'Repousse capillaire à Bruxelles — Tony&Son',
    description: "Soins repousse capillaire chez Tony&Son à Bruxelles. Traitements anti-chute et stimulation de la pousse des cheveux à Schuman.",
    crossLinks: [
...
Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Rue Bonneels 27, métro Schuman (lignes 1/5). Appelez au 02 230 55 37 ou réservez en ligne via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a>.`,
    faq: [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaDescription: 'Coupes enfants à Bruxelles chez Tony&Son, salon familial à Schuman depuis 1970. Garçons et filles. Dès 25 €. ☎ 02 230 55 37',
...
Garçons et filles, même tarif : à partir de 25 €. Dégradé, carré, frange, brosse — nos coiffeurs maîtrisent tout. Le mercredi et samedi, c'est chargé (pause des écoles + week-end). Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure</a> et <a href="/fr/barbier/">barbier à Bruxelles</a>. Réservez en ligne via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a> ou au 02 230 55 37. Rue Bonneels 27, à côté du Parc du Cinquantenaire.`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaDescription: 'Mèches à Bruxelles chez Tony&Son, salon à Schuman. Mèches aluminium, bonnet ou main levée. Coloristes experts depuis 1970. ☎ 02 230 55 37',
...
Rue Bonneels 27, entre le Parc du Cinquantenaire et le métro Schuman. Accessible depuis Schaerbeek, Etterbeek et Ixelles. Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Appelez au 02 230 55 37 ou réservez en ligne via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a>.`,
    faq: [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    titleTag: 'Kératine Bruxelles – Réparation & brillance | Tony&Son',
    metaDescription: 'Traitement à la kératine à Bruxelles chez Tony&Son. Soin réparateur, anti-frisottis, brillance. Sans formaldéhyde. Schuman. ☎ 02 230 55 37',
...
À partir de 500 €. Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Rue Bonneels 27, métro Schuman (lignes 1/5). Réservez une consultation au 02 230 55 37 ou en ligne via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a>.`,
    faq: [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    titleTag: 'Permanentes Bruxelles – Boucles & ondulations | Tony&Son',
    metaDescription: 'Permanentes modernes à Bruxelles chez Tony&Son. Spirale, bodywave, partielle. Formulations douces. Schuman. ☎ 02 230 55 37',
...
On ne fait pas de permanente sur des cheveux trop abîmés. Lissage brésilien récent ? Décoloration intensive ? Nos coiffeurs vous le diront et proposeront une alternative — un <a href="/fr/services/traitement-keratine-bruxelles/">traitement kératine</a> pour renforcer la fibre d'abord, par exemple. Comptez 2-3h au salon. Le résultat tient 3-6 mois. Rue Bonneels 27, métro Schuman (lignes 1/5). Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Réservez au 02 230 55 37 ou en ligne via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a>.`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaDescription: 'Taille de barbe à Bruxelles chez Tony&Son. Rasage traditionnel, dégradé, serviette chaude. Barbier expert à Schuman. ☎ 02 230 55 37',
...
Ce service fait partie de notre offre <a href="/fr/barbier/">barbier à Bruxelles</a>. Rue Bonneels 27, métro Schuman (lignes 1/5), tram 81. Vendredi et samedi, c'est chargé — réservez en ligne via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a> ou appelez au 02 230 55 37. Sans rendez-vous accepté en semaine, selon disponibilité.`,
    faq: [
      ...
      { question: "Faut-il réserver ou peut-on venir sans rendez-vous ?", answer: "Rendez-vous recommandé, surtout vendredi et samedi. Réservez via <a href='https://widget.treatwell.be/fr/salon/tony-son/' target='_blank' rel='noopener'>Treatwell</a> ou au 02 230 55 37. Sans rendez-vous accepté en semaine selon disponibilité." }
    ]
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    titleTag: 'Coloration dégradé Bruxelles – Ombré & dip-dye | Tony&Son',
    metaDescription: 'Coloration en dégradé à Bruxelles chez Tony&Son. Ombré, sombré, dip-dye par nos coloristes experts à Schuman. Dès 40 €. ☎ 02 230 55 37',
...
À partir de 40 €. On vous montre des exemples avant de toucher quoi que ce soit — pour être sûrs qu'on parle de la même chose. Rue Bonneels 27, métro Schuman. Ce service fait partie de notre offre <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Appelez au 02 230 55 37 ou réservez sur <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a>. Pour des techniques plus classiques : <a href="/fr/services/colorations-capillaires-bruxelles/">coloration complète</a>, <a href="/fr/services/balayage-bruxelles/">balayage</a> ou <a href="/fr/services/meches-bruxelles/">mèches</a>.`,
    faq: [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    price: 'À partir de 25 €',
    images: ['/images/barbier-1.jpg', '/images/barbier-2.jpg'],
    titleTag: 'Coupe Homme Bruxelles – Dégradé & Tendance | Tony&Son',
    metaDescription: 'Coupe homme à Bruxelles chez Tony&Son, salon à Schuman depuis 1970. Dégradé, classique, tendance. Dès 25 €. ☎ 02 230 55 37',
...
À partir de 25 €, tout compris. Le tarif varie selon la complexité (coupe simple, dégradé élaboré, combo coupe + <a href="/fr/services/taille-barbe-bruxelles/">barbe</a>). Ce service fait partie de notre offre <a href="/fr/barbier/">barbier à Bruxelles</a> et <a href="/fr/coiffure/">coiffure à Bruxelles</a>. Rue Bonneels 27, à deux minutes du métro Schuman (lignes 1 et 5). Réservez sur <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a> ou appelez au 02 230 55 37. Les vendredis et samedis se remplissent vite — anticipez.`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    titleTag: 'Teinture Sourcils Bruxelles – Coloration & forme | Tony&Son',
    metaDescription: 'Teinture de sourcils à Bruxelles chez Tony&Son. Coloration naturelle, restructuration du regard. 15 €. Schuman. ☎ 02 230 55 37',
...
On choisit la teinte ensemble — jamais trop foncée, toujours en harmonie avec votre couleur de cheveux et votre carnation. Application précise, temps de pose de quelques minutes, résultat immédiat. Se combine parfaitement avec une <a href="/fr/services/epilation-cire-bruxelles/">épilation à la cire</a> pour un résultat net en une seule séance. 15 €. Rue Bonneels 27, métro Schuman. Réservez au 02 230 55 37 ou via <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a>.`,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    metaDescription: 'Épilation à la cire du visage à Bruxelles chez Tony&Son. Sourcils, lèvre, menton. 10 €. Schuman. ☎ 02 230 55 37',
    ...
    crossLinks: [{ slug: 'taille-barbe-bruxelles', label: 'taille de barbe à Bruxelles' }],
    longDescription: `Épilation à la cire à Bruxelles, Saint-Josse-ten-Noode. Sourcils, lèvre, menton — cire tiède, geste rapide, 10 €. Hommes et femmes. Se combine avec une <a href="/fr/services/taille-barbe-bruxelles/">taille de barbe</a> ou un <a href="/fr/services/brushing-bruxelles/">brushing</a> dans la même séance — mentionnez-le à la réservation sur <a href="https://widget.treatwell.be/fr/salon/tony-son/" target="_blank" rel="noopener">Treatwell</a> ou au 02 230 55 37. Ce service fait partie de notre offre <a href="/fr/barbier/">barbier à Bruxelles</a>. Rue Bonneels 27, métro Schuman.`,
    faq: [
